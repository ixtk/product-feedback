...
export const Banner = ({ isSidebarOpen }: { isSidebarOpen: boolean }) => {
  return (
    <div className="p-4 bg-banner-sm bg-no-repeat text-base-100 bg-cover flex justify-between items-center md:bg-banner-md md:flex-1 md:rounded-xl md:items-end md:px-0">
