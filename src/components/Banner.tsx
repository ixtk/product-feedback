...
export const Banner = ({ isSidebarOpen }: { isSidebarOpen: boolean }) => {
  return (
    <div className="flex items-center justify-between bg-banner-sm bg-cover bg-no-repeat p-4 text-base-100 md:flex-1 md:items-end md:rounded-xl md:bg-banner-md md:px-0 xl:bg-banner-lg xl:pt-16">
